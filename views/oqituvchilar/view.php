...
<html lang="en">
  <head>
    <title>120-MTT | O'qituvchilar</title>
    <meta charset="utf-8">
        ...
        <div class="container d-flex align-items-center">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item  active"><a href="?page=start&hook=Oqituvchilar" class="nav-link">O'qituvchilar</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Asosiy <i class="ion-ios-arrow-forward"></i></a></span> <span>O'qituvchilar <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
  ...
  <?php  foreach($teachers as $teacher) { ?>
    <tr>
      <td class="bg-success text-white"><?php echo $teacher['name']; ?></td>
      <td class="bg-primary text-white"><?php echo $teacher['subject']; ?></td>
    </tr>  
	<?php } ?> 
  </tbody>
</table>                    
