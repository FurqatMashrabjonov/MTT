        ...
        <div class="container d-flex align-items-center">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="?page=start&hook=Qiziqarli" class="nav-link">Qiziqarli</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Qiziqarli</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Asosiy <i class="ion-ios-arrow-forward"></i></a></span> <span>Qiziqarli <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container">
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('images/<?php echo $blog['image'] ?>');">
              </a>
              <div class="text bg-white p-4">
                <h3 class="heading"><a href="#"><?php echo $blog['name'] ?></a></h3>
